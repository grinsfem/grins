...
namespace GRINS
{
  //! Physics class for Magnetostatics
  /*
    This physics class implements magentostatics using the potential form of the
    equations.
   */
  class Magnetostatics : public Physics
  {
  public:
    Magnetostatics( const std::string& physics_name, const GetPot& input );
    ~Magnetostatics();

    //! Initialization  HeatTransfer variables
    /*!
