...
#ifndef GRINS_INCOMPRESSIBLE_HYPERELASTICITY_H
#define GRINS_INCOMPRESSIBLE_HYPERELASTICITY_H
...
namespace GRINS
{
  ...
  class IncompressibleHyperelasticity : public HyperelasticityBase<Dim,StrainEnergy>
  {
  public:
...
#endif // GRINS_INCOMPRESSIBLE_HYPERELASTICITY_H
