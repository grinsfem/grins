...
namespace GRINS
{
  ...
  template<class Mu, class SH, class TC>
  void LowMachNavierStokesStabilizationBase<Mu,SH,TC>::init_context( libMesh::DiffContext &context )
  {
  ...
  template<class Mu, class SH, class TC>
  libMesh::Real LowMachNavierStokesStabilizationBase<Mu,SH,TC>::compute_res_continuity_steady( libMesh::FEMContext& c,
  ...
  template<class Mu, class SH, class TC>
  libMesh::Real LowMachNavierStokesStabilizationBase<Mu,SH,TC>::compute_res_continuity_transient( libMesh::FEMContext& c,
												  unsigned int qp ) const
  {
    libMesh::Real T = c.fixed_interior_value(this->_T_var, qp);
  ...
  template<class Mu, class SH, class TC>
  libMesh::RealGradient LowMachNavierStokesStabilizationBase<Mu,SH,TC>::compute_res_momentum_steady( libMesh::FEMContext& c,
												     unsigned int qp ) const
  {
    libMesh::Real T = c.fixed_interior_value(this->_T_var, qp);
  ...
  template<class Mu, class SH, class TC>
  libMesh::RealGradient LowMachNavierStokesStabilizationBase<Mu,SH,TC>::compute_res_momentum_transient( libMesh::FEMContext& c,
													unsigned int qp ) const
  {
    libMesh::Real T = c.fixed_interior_value(this->_T_var, qp);
    libMesh::Real rho = this->rho(T, this->get_p0_transient(c,qp) );
  ...
  template<class Mu, class SH, class TC>
  libMesh::Real LowMachNavierStokesStabilizationBase<Mu,SH,TC>::compute_res_energy_steady( libMesh::FEMContext& c,
											   unsigned int qp ) const
  {
    libMesh::Real T = c.fixed_interior_value(this->_T_var, qp);
    libMesh::Gradient grad_T = c.fixed_interior_gradient(this->_T_var, qp);
  ...
  template<class Mu, class SH, class TC>
  libMesh::Real LowMachNavierStokesStabilizationBase<Mu,SH,TC>::compute_res_energy_transient( libMesh::FEMContext& c,
											      unsigned int qp ) const
  {
    libMesh::Real T = c.fixed_interior_value(this->_T_var, qp);
    libMesh::Real rho = this->rho(T, this->get_p0_transient(c,qp) );
