...
//-----------------------------------------------------------------------el-
//
// $Id: axisym_boussinesq_buoyancy.C 29886 2012-05-09 17:54:07Z pbauman $
//
//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
...
GRINS::AxisymmetricLorentzForce::AxisymmetricLorentzForce( const std::string& physics_name,
							   const GetPot& input )
...
GRINS::AxisymmetricLorentzForce::~AxisymmetricLorentzForce()
{
  return;
}

void GRINS::AxisymmetricLorentzForce::read_input_options( const GetPot& input )
{
  this->_u_FE_family =
...
void GRINS::AxisymmetricLorentzForce::init_variables( libMesh::FEMSystem* system )
{
...
bool GRINS::AxisymmetricLorentzForce::element_time_derivative( bool request_jacobian,
								     ...
								     libMesh::FEMSystem* system )
{
  ...
  c.get_element_fe<Real>( _u_r_var, u_r_fe );
...
void GRINS::AxisymmetricLorentzForce::init_context( libMesh::DiffContext &context )
{
  return;
}

bool GRINS::AxisymmetricLorentzForce::side_time_derivative( bool request_jacobian,
						      libMesh::DiffContext& context,
						      libMesh::FEMSystem* system )
{
  return request_jacobian;
...
bool GRINS::AxisymmetricLorentzForce::element_constraint( bool request_jacobian,
						    libMesh::DiffContext& context,
						    libMesh::FEMSystem* system )
{
  return request_jacobian;
...
bool GRINS::AxisymmetricLorentzForce::side_constraint( bool request_jacobian,
						 libMesh::DiffContext& context,
						 libMesh::FEMSystem* system )
{
  return request_jacobian;
...
bool GRINS::AxisymmetricLorentzForce::mass_residual( bool request_jacobian,
					       libMesh::DiffContext& context,
					       libMesh::FEMSystem* system )
{
  return request_jacobian;
