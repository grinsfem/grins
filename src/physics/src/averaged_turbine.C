...
namespace GRINS
{
    ...
    if( this->_dim == 3 )
      {
        ...
        Ksw = &context.get_elem_jacobian(this->fan_speed_var(), this->_flow_vars.w_var()); // R_{s},{w}
				                ...
				                CachedValues& /* cache */ )
  {
    ...
    const libMesh::DenseSubVector<libMesh::Number> &Us =
      context.get_elem_solution(this->fan_speed_var());
