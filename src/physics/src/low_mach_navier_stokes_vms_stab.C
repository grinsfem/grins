...
namespace GRINS
{
  ...
  template<class Mu, class SH, class TC>
  bool LowMachNavierStokesVMSStabilization<Mu,SH,TC>::element_time_derivative( bool request_jacobian,
  ...
  template<class Mu, class SH, class TC>
  bool LowMachNavierStokesVMSStabilization<Mu,SH,TC>::mass_residual( bool request_jacobian,
								     libMesh::DiffContext& context,
								     libMesh::FEMSystem* system )
  {
#ifdef GRINS_USE_GRVY_TIMERS
  ...
  template<class Mu, class SH, class TC>
  void LowMachNavierStokesVMSStabilization<Mu,SH,TC>::assemble_continuity_time_deriv( bool request_jacobian,
  ...
  template<class Mu, class SH, class TC>
  void LowMachNavierStokesVMSStabilization<Mu,SH,TC>::assemble_momentum_time_deriv( bool request_jacobian,
										    libMesh::FEMContext& c,
										    libMesh::FEMSystem* system )
  {
    // The number of local degrees of freedom in each variable.
  ...
  template<class Mu, class SH, class TC>
  void LowMachNavierStokesVMSStabilization<Mu,SH,TC>::assemble_energy_time_deriv( bool request_jacobian,
										  libMesh::FEMContext& c,
										  libMesh::FEMSystem* system )
  {
    // The number of local degrees of freedom in each variable.
  ...
  template<class Mu, class SH, class TC>
  void LowMachNavierStokesVMSStabilization<Mu,SH,TC>::assemble_continuity_mass_residual( bool request_jacobian,
											 libMesh::FEMContext& c,
											 libMesh::FEMSystem* system )
  {
    // The number of local degrees of freedom in each variable.
  ...
  template<class Mu, class SH, class TC>
  void LowMachNavierStokesVMSStabilization<Mu,SH,TC>::assemble_momentum_mass_residual( bool request_jacobian,
										       libMesh::FEMContext& c,
										       libMesh::FEMSystem* system )
  {
    // The number of local degrees of freedom in each variable.
  ...
  template<class Mu, class SH, class TC>
  void LowMachNavierStokesVMSStabilization<Mu,SH,TC>::assemble_energy_mass_residual( bool request_jacobian,
										     libMesh::FEMContext& c,
										     libMesh::FEMSystem* system )
  {
    // The number of local degrees of freedom in each variable.
  ...
  template<class Mu, class SH, class TC>
  bool LowMachNavierStokesVMSStabilization<Mu,SH,TC>::element_constraint( bool request_jacobian,
									  libMesh::DiffContext& context,
									  libMesh::FEMSystem* system )
  {
#ifdef GRINS_USE_GRVY_TIMERS
  ...
  template<class Mu, class SH, class TC>
  bool LowMachNavierStokesVMSStabilization<Mu,SH,TC>::side_time_derivative( bool request_jacobian,
									    libMesh::DiffContext& context,
									    libMesh::FEMSystem* system )
  {
#ifdef GRINS_USE_GRVY_TIMERS
  ...
  template<class Mu, class SH, class TC>
  bool LowMachNavierStokesVMSStabilization<Mu,SH,TC>::side_constraint( bool request_jacobian,
								       libMesh::DiffContext& context,
								       libMesh::FEMSystem* system )
  {
#ifdef GRINS_USE_GRVY_TIMERS
