...
namespace GRINS
{
  ...
  void AxisymmetricElectrostaticsBCHandling::init_bc_types( const GRINS::BoundaryID bc_id, 
  ...
  void AxisymmetricElectrostaticsBCHandling::user_apply_neumann_bcs( AssemblyContext& context,
