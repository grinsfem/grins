...
#ifndef GRINS_COMPOSITE_FUNCTION_H
#define GRINS_COMPOSITE_FUNCTION_H
...
class CompositeFunction : public libMesh::FunctionBase<Output>
{
public:
  explicit
  CompositeFunction () {}
  ...
  virtual Output operator() (const libMesh::Point& p,
  ...
  virtual libMesh::AutoPtr<libMesh::FunctionBase<Output> > clone() const {
...
#endif // GRINS_COMPOSITE_FUNCTION_H
