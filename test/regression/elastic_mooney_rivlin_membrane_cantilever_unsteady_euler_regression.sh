...
INPUT="${GRINS_TEST_INPUT_DIR}/elastic_mooney_rivlin_membrane_cantilever_unsteady_euler_regression.in"
TESTDATA="./elastic_mooney_rivlin_membrane_cantilever_unsteady_euler_regression.99.xda.gz"
TESTDATA_NOTUSED="./elastic_mooney_rivlin_membrane_cantilever_unsteady_euler_regression.xda.gz"
GOLDDATA="${GRINS_TEST_DATA_DIR}/elastic_mooney_rivlin_membrane_cantilever_unsteady_euler_regression.99.xda.gz"
