...
INPUT="${GRINS_TEST_INPUT_DIR}/reacting_low_mach_antioch_cea_constant_mole_fraction_input_regression.in"

# The mole fractions input should produce the same solution as the mass fraction case
