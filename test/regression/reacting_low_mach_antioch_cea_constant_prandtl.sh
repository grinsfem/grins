...
INPUT="${GRINS_TEST_INPUT_DIR}/reacting_low_mach_antioch_cea_constant_prandtl_regression.in"
DATA="${GRINS_TEST_DATA_DIR}/reacting_low_mach_antioch_cea_constant_prandtl_regression.xdr"
