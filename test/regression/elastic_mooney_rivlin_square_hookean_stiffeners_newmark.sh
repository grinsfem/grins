...
INPUT="${GRINS_TEST_INPUT_DIR}/elastic_mooney_rivlin_square_hookean_stiffeners_newmark_regression.in"
DATA="${GRINS_TEST_DATA_DIR}/elastic_mooney_rivlin_square_hookean_stiffeners_newmark_regression.xdr"
