...
INPUT="${GRINS_TEST_INPUT_DIR}/reacting_low_mach_antioch_cea_constant_regression.in ${GRINS_TEST_DATA_DIR}/reacting_low_mach_antioch_cea_constant_regression.xdr"
