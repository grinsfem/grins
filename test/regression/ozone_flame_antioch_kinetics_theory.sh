...
INPUT="${GRINS_TEST_INPUT_DIR}/ozone_flame_antioch_kinetics_theory_regression.in"

# Reuse the restart from the constant transport case until
# we can actually get the kinetics theory case to work.
